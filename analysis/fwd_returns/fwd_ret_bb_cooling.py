...
from utils.prepare_df import (
    TickersData,
    add_features_forecasts_to_ohlc_v3,
    get_df_with_fwd_ret,
)
...
def analyze_fwd_ret_by_bb_cooling():
    ...
    depending on the bb_cooling feature.
    The bb_cooling feature indicates whether oversold or overbought conditions started to cool off.
    ...
    for ticker in tickers_all:
        ...
        ohlc_with_forecast_bb_and_fwd_ret = get_df_with_fwd_ret(
            ...
            add_features_forecasts_func=add_features_forecasts_to_ohlc_v3,
